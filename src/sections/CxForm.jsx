...
const CxForm = () => {
  ...
  const onInvalid = (erros) => {
    const allData = methods.getValues() // <-- pega tudo, mesmo inválido
  ...
  return (
    <div className="flex justify-center items-center relative pt-10 max-lg:landscape:pt-80 max-lg:landscape:pb-60 px-7 h-full w-full bg-red-white">
      ...
      <FormProvider {...methods}>
        <form className="max-w-full space-y-8" onSubmit={methods.handleSubmit(onValid, onInvalid)}>
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <Controller // adaptador entre RHF e um input complexo como IMask
                  ...
                  control={methods.control}// control --> conecta esse campo ao formulário global
                  render={({ field }) => {
